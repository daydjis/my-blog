...
import { fetchReport } from '../../store/reducer/ActionCreator'
import './weather.scss'
  ...
  return !isLoading ? (
    <div className='wrapper'>
      <div className='content-weather'>
        ...
        <div className='img'>
          <img className='img-item' src={weather.current?.condition?.icon} alt='icon' />
        </div>
        ...
        <h6 className='Error'>{disabled ? 'Введи название города' : ''}</h6>
      </div>
    </div>
  ) : (
    <div className='wrapper'>
